...
return [
    'custom' => [
        ...
        'myTheme' => env('TEMPLATE_THEME', 'theme-default'), // Options[String]: theme-default(default), theme-bordered, theme-semi-dark
        'myStyle' => env('THEME_STYLE', 'dark'), // Options[String]: light(default), dark & system mode
