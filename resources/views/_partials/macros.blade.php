...
<span>
    <svg width="{{ $width }}" viewBox="0 0 38 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <linearGradient id="honeycomb-gradient" x1="0" y1="0" x2="1" y2="1">
                <stop offset="0%" stop-color="#FFD700" /> <!-- Emas terang -->
                <stop offset="100%" stop-color="#FF8C00" /> <!-- Oranye keemasan -->
            </linearGradient>
            <style>
                .cls-1 {
