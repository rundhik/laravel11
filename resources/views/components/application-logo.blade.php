<svg viewbox="0 0 148 80" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="20">
    <defs>
        <lineargradient id="a1" x1="46.49" x2="62.46" y1="53.39" y2="48.2"
            gradientunits="userSpaceOnUse">
            <stop stop-opacity=".25" offset="0"></stop>
            <stop stop-opacity=".1" offset=".3"></stop>
            <stop stop-opacity="0" offset=".9"></stop>
        </lineargradient>
        <lineargradient id="e2" x1="76.9" x2="92.64" y1="26.38" y2="31.49" xlink:href="#a">
        </lineargradient>
        <lineargradient id="d3" x1="107.12" x2="122.74" y1="53.41" y2="48.33" xlink:href="#a">
        </lineargradient>
    </defs>
