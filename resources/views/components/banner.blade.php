...
<div class="alert alert-banner mb-0 rounded-0"
    :class="{ 'bg-success': style == 'success', 'bg-danger': style == 'danger', 'bg-secondary': style != 'success' && style !=
            'danger' }"
    role="alert" x-data="{ show: true, style: '{{ $style }}', message: '{{ $message }}' }" x-show="show && message" x-init="document.addEventListener('banner-message', event => {
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="text-end">
            <button type="button" class="btn btn-icon btn-sm"
                ...
                <svg class="h-px-20 w-px-20 text-white" xmlns="http://www.w3.org/2000/svg" fill="none"
